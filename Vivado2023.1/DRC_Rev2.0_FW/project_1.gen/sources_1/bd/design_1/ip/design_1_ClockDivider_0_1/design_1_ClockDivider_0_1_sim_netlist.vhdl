...
--               c:/Xilinx/Projects/DRC_Rev2.0_Deliverables/Vivado2023.1/DRC_Rev2.0_FW/project_1.gen/sources_1/bd/design_1/ip/design_1_ClockDivider_0_1/design_1_ClockDivider_0_1_sim_netlist.vhdl
...
entity design_1_ClockDivider_0_1_ClockDivider is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_ClockDivider_0_1_ClockDivider : entity is "ClockDivider";
end design_1_ClockDivider_0_1_ClockDivider;

architecture STRUCTURE of design_1_ClockDivider_0_1_ClockDivider is
  signal \^clkout\ : STD_LOGIC;
  signal clear : STD_LOGIC;
  signal \clkstate1_carry__0_i_10_n_0\ : STD_LOGIC;
  signal \clkstate1_carry__0_i_11_n_0\ : STD_LOGIC;
  signal \clkstate1_carry__0_i_12_n_0\ : STD_LOGIC;
  ...
  signal \clkstate1_carry__0_i_5_n_0\ : STD_LOGIC;
  signal \clkstate1_carry__0_i_6_n_0\ : STD_LOGIC;
  signal \clkstate1_carry__0_i_7_n_0\ : STD_LOGIC;
  signal \clkstate1_carry__0_i_8_n_0\ : STD_LOGIC;
  signal \clkstate1_carry__0_i_9_n_0\ : STD_LOGIC;
  signal \clkstate1_carry__0_n_2\ : STD_LOGIC;
  signal \clkstate1_carry__0_n_3\ : STD_LOGIC;
  signal \clkstate1_carry__0_n_4\ : STD_LOGIC;
  signal \clkstate1_carry__0_n_5\ : STD_LOGIC;
  ...
  signal minusOp : STD_LOGIC_VECTOR ( 27 downto 1 );
  ...
  signal \NLW_clkstate1_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 6 );
  ...
  signal \NLW_minusOp_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 2 );
  signal \NLW_minusOp_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 3 );
...
\clkstate1_carry__0\: unisim.vcomponents.CARRY8
     port map (
      ...
      CI_TOP => '0',
      CO(7 downto 6) => \NLW_clkstate1_carry__0_CO_UNCONNECTED\(7 downto 6),
      CO(5) => \clkstate1_carry__0_n_2\,
      CO(4) => \clkstate1_carry__0_n_3\,
      CO(3) => \clkstate1_carry__0_n_4\,
      CO(2) => \clkstate1_carry__0_n_5\,
      CO(1) => \clkstate1_carry__0_n_6\,
      CO(0) => \clkstate1_carry__0_n_7\,
      DI(7 downto 6) => B"00",
      DI(5) => \clkstate1_carry__0_i_1_n_0\,
      DI(4) => \clkstate1_carry__0_i_2_n_0\,
      DI(3) => \clkstate1_carry__0_i_3_n_0\,
      DI(2) => \clkstate1_carry__0_i_4_n_0\,
      DI(1) => \clkstate1_carry__0_i_5_n_0\,
      DI(0) => \clkstate1_carry__0_i_6_n_0\,
      O(7 downto 0) => \NLW_clkstate1_carry__0_O_UNCONNECTED\(7 downto 0),
      S(7 downto 6) => B"00",
      S(5) => \clkstate1_carry__0_i_7_n_0\,
      S(4) => \clkstate1_carry__0_i_8_n_0\,
      S(3) => \clkstate1_carry__0_i_9_n_0\,
      S(2) => \clkstate1_carry__0_i_10_n_0\,
      S(1) => \clkstate1_carry__0_i_11_n_0\,
      S(0) => \clkstate1_carry__0_i_12_n_0\
    );
\clkstate1_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\clkstate1_carry__0_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => minusOp(20),
      I1 => minusOp(21),
      O => \clkstate1_carry__0_i_10_n_0\
    );
\clkstate1_carry__0_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => minusOp(19),
      I3 => counter_reg(19),
      O => \clkstate1_carry__0_i_11_n_0\
    );
\clkstate1_carry__0_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => minusOp(17),
      I3 => counter_reg(17),
      O => \clkstate1_carry__0_i_12_n_0\
    );
\clkstate1_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\clkstate1_carry__0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\clkstate1_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\clkstate1_carry__0_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => counter_reg(19),
      I3 => minusOp(19),
      O => \clkstate1_carry__0_i_5_n_0\
    );
\clkstate1_carry__0_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => counter_reg(17),
      I3 => minusOp(17),
      O => \clkstate1_carry__0_i_6_n_0\
    );
\clkstate1_carry__0_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => minusOp(26),
      I1 => minusOp(27),
      O => \clkstate1_carry__0_i_7_n_0\
    );
\clkstate1_carry__0_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => minusOp(24),
      I1 => minusOp(25),
      O => \clkstate1_carry__0_i_8_n_0\
    );
\clkstate1_carry__0_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\minusOp_carry__1\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7 downto 0) => counterVal(24 downto 17),
...
\minusOp_carry__2\: unisim.vcomponents.CARRY8
     port map (
      ...
      CI_TOP => '0',
      CO(7 downto 2) => \NLW_minusOp_carry__2_CO_UNCONNECTED\(7 downto 2),
      CO(1) => \minusOp_carry__2_n_6\,
      CO(0) => \minusOp_carry__2_n_7\,
      DI(7 downto 2) => B"000000",
      DI(1 downto 0) => counterVal(26 downto 25),
      O(7 downto 3) => \NLW_minusOp_carry__2_O_UNCONNECTED\(7 downto 3),
      O(2 downto 0) => minusOp(27 downto 25),
...
entity design_1_ClockDivider_0_1 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_ClockDivider_0_1 : entity is "design_1_ClockDivider_0_1,ClockDivider,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_ClockDivider_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_ClockDivider_0_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_ClockDivider_0_1 : entity is "ClockDivider,Vivado 2023.1";
end design_1_ClockDivider_0_1;

architecture STRUCTURE of design_1_ClockDivider_0_1 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of CLKIN : signal is "xilinx.com:signal:clock:1.0 CLKIN CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of CLKIN : signal is "XIL_INTERFACENAME CLKIN, FREQ_HZ 259997400, FREQ_TOLERANCE_HZ 0, PHASE 10.0, CLK_DOMAIN design_1_clk_wiz_0_0_clk_out1, INSERT_VIP 0";
begin
inst: entity work.design_1_ClockDivider_0_1_ClockDivider
     port map (
      CLKIN => CLKIN,
      CLKOUT => CLKOUT,
      counterVal(27 downto 0) => counterVal(27 downto 0)
    );
end STRUCTURE;
