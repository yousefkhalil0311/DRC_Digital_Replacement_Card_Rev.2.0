...
--               c:/Xilinx/Projects/DRC_Rev2.0_Deliverables/Vivado2023.1/DRC_Rev2.0_FW/project_1.gen/sources_1/bd/design_1/ip/design_1_DAC_CTRL_0_1/design_1_DAC_CTRL_0_1_sim_netlist.vhdl
...
entity design_1_DAC_CTRL_0_1_DAC_CTRL is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_DAC_CTRL_0_1_DAC_CTRL : entity is "DAC_CTRL";
end design_1_DAC_CTRL_0_1_DAC_CTRL;

architecture STRUCTURE of design_1_DAC_CTRL_0_1_DAC_CTRL is
  signal \^dacdata\ : STD_LOGIC_VECTOR ( 11 downto 0 );
  signal DACVAL1 : STD_LOGIC;
  signal DACVAL10_out : STD_LOGIC;
  signal \DACVAL[0]_i_1_n_0\ : STD_LOGIC;
  signal \DACVAL[10]_i_1_n_0\ : STD_LOGIC;
  signal \DACVAL[11]_i_10_n_0\ : STD_LOGIC;
  signal \DACVAL[11]_i_11_n_0\ : STD_LOGIC;
  ...
  signal isDCLK1_i_2_n_0 : STD_LOGIC;
  signal isDCLK1_i_3_n_0 : STD_LOGIC;
  signal p_0_in : STD_LOGIC;
  signal p_2_in : STD_LOGIC;
  attribute SYNTH_INFERRED : boolean;
  attribute SYNTH_INFERRED of isDCLK1_reg : label is std.standard.true;
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of isDCLK1_reg : label is "FDCP_1";
begin
...
\DACVAL[11]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF74FF778B008800"
    )
        port map (
...
\DACVAL[11]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\DACVAL[11]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\DACVAL[11]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\DACVAL[11]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\DACVAL[11]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\DACVAL[11]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\DACVAL[11]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
isDCLK1_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
isDCLK1_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
isDCLK1_reg: unisim.vcomponents.FDCP
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_DAC_CTRL_0_1 is
  port (
    CLKIN : in STD_LOGIC;
    CONSTMODE : in STD_LOGIC;
    DATA_INA_MIN : in STD_LOGIC_VECTOR ( 11 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_DAC_CTRL_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_DAC_CTRL_0_1 : entity is "design_1_DAC_CTRL_0_1,DAC_CTRL,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_DAC_CTRL_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_DAC_CTRL_0_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_DAC_CTRL_0_1 : entity is "DAC_CTRL,Vivado 2023.1";
end design_1_DAC_CTRL_0_1;

architecture STRUCTURE of design_1_DAC_CTRL_0_1 is
...
begin
inst: entity work.design_1_DAC_CTRL_0_1_DAC_CTRL
     port map (
      CLKIN => CLKIN,
      CONSTMODE => CONSTMODE,
      DACDATA(11 downto 0) => DACDATA(11 downto 0),
