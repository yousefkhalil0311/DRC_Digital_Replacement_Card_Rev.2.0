...
set_property DRIVE 16 [get_ports {IOBUF_CLKP[0]}]
set_property SLEW FAST [get_ports {IOBUF_CLKP[0]}]
set_property DRIVE 16 [get_ports {IOBUF_CLKN[0]}]
set_property SLEW FAST [get_ports {IOBUF_CLKN[0]}]
