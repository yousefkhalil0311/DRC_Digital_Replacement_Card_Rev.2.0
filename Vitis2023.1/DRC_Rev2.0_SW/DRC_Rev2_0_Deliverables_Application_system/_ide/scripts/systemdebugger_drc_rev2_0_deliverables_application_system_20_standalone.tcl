...
# Path of this script: C:\Xilinx\Projects\DRC_Rev2.0_Deliverables\Vitis2023.1\DRC_Rev2.0_SW\DRC_Rev2_0_Deliverables_Application_system\_ide\scripts\systemdebugger_drc_rev2_0_deliverables_application_system_20_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\Xilinx\Projects\DRC_Rev2.0_Deliverables\Vitis2023.1\DRC_Rev2.0_SW\DRC_Rev2_0_Deliverables_Application_system\_ide\scripts\systemdebugger_drc_rev2_0_deliverables_application_system_20_standalone.tcl
# 
...
set bp_59_58_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_59_58_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
